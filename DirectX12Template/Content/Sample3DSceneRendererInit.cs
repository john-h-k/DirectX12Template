...
namespace DirectX12Template.Content
{
    public partial class Sample3DSceneRenderer
    {
        ...
        private unsafe void CreatePipelineDescAndPipelineState()
        {
            ...
            state.RasterizerState = CD3DX12_RASTERIZER_DESC.Create(CD3DX12_DEFAULT.D3D12_DEFAULT);
            state.BlendState = CD3DX12_BLEND_DESC.Create(CD3DX12_DEFAULT.D3D12_DEFAULT);
            state.DepthStencilState = CD3DX12_DEPTH_STENCIL_DESC.Create(CD3DX12_DEFAULT.D3D12_DEFAULT);
            ...
            {
                Guid iid = D3D12.IID_ID3D12PipelineState;
